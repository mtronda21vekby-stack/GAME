...
export const NEXT_MAP_ZONES: NextZoneDefinition[] = [
  {
    id: "safe_spring",
    name: "Safe Spring",
    description: "Учебная безопасная зона: сильное восстановление, низкая награда.",
    x: 790,
    y: 655,
    radius: 520,
    risk: 0,
  ...
  },
  {
    id: "reef",
    name: "Reef Garden",
    description: "Стабильный риф: мягкое лечение и базовый фарм без сильного давления.",
    x: 1560,
    y: 1120,
    radius: 640,
    risk: 1,
  ...
  },
  {
    id: "pearl_bank",
    name: "Pearl Bank",
    description: "Жемчужная банка: лучший безопасный фарм жемчуга без давления.",
    x: 1270,
    y: 2620,
    radius: 560,
    risk: 1,
  ...
  },
  {
    id: "coral_garden",
    name: "Coral Garden",
    description: "Коралловый сад: выше шанс кристаллов и хорошая награда при среднем риске.",
    x: 2480,
    y: 2480,
    radius: 650,
    risk: 2,
  ...
  },
  {
    id: "kelp_current",
    name: "Kelp Highway",
    description: "Скоростное течение: быстрый маршрут через карту и умеренный бонус наград.",
    x: 2710,
    y: 840,
    radius: 720,
    risk: 2,
  ...
  },
  {
    id: "sunken_vault",
    name: "Sunken Vault",
    description: "Затонувшее хранилище: заметная награда, но начинается давление.",
    x: 3600,
    y: 1240,
    radius: 620,
    risk: 3,
    rewardMultiplier: 1.34,
    pressureDamagePerSecond: 1.8,
    color: "rgba(255,220,120,.12)"
  },
  {
    id: "storm_current",
    name: "Storm Current",
    description: "Штормовое течение: быстрый рискованный перенос и усиленный фарм.",
    x: 4020,
    y: 2740,
    radius: 720,
    risk: 3,
    ...
    driftX: -96,
    driftY: -68,
    pressureDamagePerSecond: 0.8,
    color: "rgba(120,180,255,.13)"
  },
  {
    id: "deep_trench",
    name: "Deep Trench",
    description: "Глубокая впадина: высокий риск, сильное давление и высокий множитель наград.",
    x: 4740,
    y: 1760,
    radius: 670,
    risk: 4,
  ...
  },
  {
    id: "apex_waters",
    name: "Apex Waters",
    description: "Элитная зона охоты: максимальный риск основной карты и лучшие выплаты.",
    x: 4540,
    y: 560,
    radius: 680,
    risk: 5,
    rewardMultiplier: 1.62,
    pressureDamagePerSecond: 3.1,
...
export const DARK_CAVE_ZONES: NextZoneDefinition[] = [
  ...
  },
  {
    id: "neon_forest",
    name: "Neon Forest",
    description: "Светящиеся водоросли ускоряют перемещение и дают стабильный фарм.",
    x: 1700,
    y: 2320,
    radius: 720,
    risk: 2,
  ...
  },
  {
    id: "ancient_ruins",
    name: "Ancient Ruins",
    description: "Древние руины с плотными ресурсами и заметным бонусом наград.",
    x: 2480,
    y: 980,
    radius: 650,
    risk: 3,
  ...
  },
  {
    id: "crystal_maze",
    name: "Crystal Maze",
    description: "Кристаллический лабиринт давит на броню, но усиливает фарм кристаллов.",
    x: 3760,
    y: 2360,
    radius: 760,
    risk: 4,
  ...
  },
  {
    id: "echo_core",
    name: "Echo Core",
    description: "Сюжетное сердце пещеры. Высокое давление и сильные выплаты.",
    x: 4380,
    y: 840,
    radius: 670,
    risk: 5,
  ...
  },
  {
    id: "void_rift",
    name: "Void Rift",
    description: "Глубокий разлом. Самая жёсткая зона текущей поздней игры.",
    x: 4740,
    y: 3020,
    radius: 580,
    risk: 5,
    rewardMultiplier: 1.82,
    pressureDamagePerSecond: 4.8,
