      ...
      <section className="efBetaHomeShell">
        <header className="efBetaHomeHero">
          <div>
            ...
            <h1>EvoFish</h1>
            <p>Расти, собирай ресурсы, открывай мутации и прокачивай скины рыб.</p>
          </div>
