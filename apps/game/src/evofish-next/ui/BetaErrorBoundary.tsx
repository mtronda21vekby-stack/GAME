...
type BetaErrorBoundaryProps = { children: React.ReactNode };
type BetaErrorBoundaryState = { error: Error | null; report: EvoFishSaveDoctorReport | null };
...
export class BetaErrorBoundary extends React.Component<BetaErrorBoundaryProps, BetaErrorBoundaryState> {
  ...
  private repairSave = () => this.setState({ report: repairEvoFishNextSave() });
  private resetRun = () => this.setState({ report: resetEvoFishNextRun() });
