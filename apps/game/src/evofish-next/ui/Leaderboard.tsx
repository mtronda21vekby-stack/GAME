...
export function Leaderboard() {
  ...
  return (
    <main className="efLeaderboard">
      ...
      <style>{`.efLeaderboard{isolation:isolate;overflow-x:hidden;background:#020915!important;background-image:linear-gradient(180deg,rgba(2,9,21,.14),rgba(2,9,21,.72)),url("/game/assets/lobby/lobby-bg-station-16x9.png")!important;background-size:cover!important;background-position:center!important;background-attachment:fixed!important}.efLeaderboard:before{position:fixed!important;inset:0!important;z-index:0;background:radial-gradient(ellipse at 50% 18%,rgba(53,216,255,.20),transparent 36%),linear-gradient(90deg,rgba(2,9,21,.42),transparent 32%,transparent 68%,rgba(2,9,21,.42))!important}.efLeaderboard:after{position:fixed!important;opacity:.24!important;z-index:0}.efLbShell{padding-bottom:calc(98px + env(safe-area-inset-bottom))!important}.efLbHero,.efLbStats article,.efLbBoard,.efLbOffline{border-radius:8px!important;border-color:rgba(88,210,255,.22)!important;background:linear-gradient(180deg,rgba(255,255,255,.075),rgba(255,255,255,.025)),rgba(5,18,32,.62)!important;box-shadow:0 18px 60px rgba(0,0,0,.32),inset 0 1px 0 rgba(255,255,255,.08)!important}.efLbRow.me{border-radius:8px!important}.efLobbyBottomNav{position:fixed;left:50%;bottom:max(12px,env(safe-area-inset-bottom));z-index:20;transform:translateX(-50%);width:min(520px,calc(100vw - 24px));border:1px solid rgba(88,210,255,.25);border-radius:999px;padding:8px;display:grid;grid-template-columns:repeat(3,1fr);gap:6px;background:linear-gradient(180deg,rgba(255,255,255,.075),rgba(255,255,255,.025)),rgba(5,18,32,.72);box-shadow:0 18px 60px rgba(0,0,0,.32),inset 0 1px 0 rgba(255,255,255,.08);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}.efLobbyBottomNav a{min-height:54px;border-radius:999px;display:grid;place-items:center;align-content:center;gap:2px;text-decoration:none;color:rgba(234,247,255,.62);font-size:11px;font-weight:950}.efLobbyBottomNav span{font-size:16px}.efLobbyBottomNav b{font-size:11px}@media(max-width:560px){.efLobbyBottomNav{width:calc(100vw - 18px)}}`}</style>
    </main>
  );
}
