      ...
      <section className="efLobbyHero">
        ...
        <div className="efLobbyGrid">
          ...
          <div className="efStatsPanel">
            <article><span>Best Mass</span><b>{account.bestMass.toFixed(2)}</b></article>
            <article><span>Total Kills</span><b>{account.totalKills}</b></article>
            <article><span>Last Run</span><b>+{account.lastRunXp} XP</b></article>
            <article><span>Wallet</span><b>{save.economy.pearls}P · {save.economy.corals}C</b></article>
          </div>
        </div>
        ...
        <div className="efModeGrid">
          ...
          <Link className="efModeCard season" to="/game/season">
            <b>Season 1</b>
            <span>Neon Abyss награды, TOP 1 / TOP 10 / TOP 100 и цели сезона.</span>
            <em>SEASON</em>
          </Link>
