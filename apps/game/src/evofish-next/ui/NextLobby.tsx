    ...
    <main className="efLobby">
      ...
      <section className="efLobbyHero">
        ...
        <div className="efModeGrid">
          ...
          <Link className="efModeCard" to="/game/next/progress">
            <b>Beta Progress</b>
            <span>Save Doctor, quests, achievements, pickups and mutations.</span>
            <em>PROGRESS</em>
          </Link>
