...
export function NextPlaytest() {
  ...
  useEffect(() => {
    ...
    const engine = createNextWorld(skin, save.progress, save.economy);
  ...
  }, [skin, save.progress, save.economy]);
  ...
  return (
    <main className="efNextPlay">
      ...
      <div className="efNextHelp">Kill/Eat дают XP, жемчуг и шанс коралла. Валюта сохраняется и работает в Skin Lab.</div>
