...
function isMapButton(target: EventTarget | null) {
  ...
  if (!button || !button.closest(".efQuickBar")) return false;
...
export function MapModalFixOverlay() {
  ...
  useEffect(() => {
    ...
    return () => document.removeEventListener("click", interceptMapOpen, true);
  }, []);
