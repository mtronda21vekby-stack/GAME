...
export const WORLD_CATALOG = [
  ...
  },
  {
    id: "quiet-valley",
    title: "Quiet Valley",
    eyebrow: "FARM WORLD · ALPHA",
    description: "Живая 3D-ферма: растения, животные, заказы жителей, мягкая аренда, сюжет и развитие территории.",
    version: "0.5.0-blackcrown.1",
    maturity: "alpha",
    lobbyRoute: "/lobby/world/quiet-valley",
    runtimeUrl: "/lobby/runtime/quiet-valley/index.html",
    runtimeKind: "isolated-html",
    previewAsset: "/lobby/worlds/quiet-valley/preview.webp",
    accent: "#b9dc82",
