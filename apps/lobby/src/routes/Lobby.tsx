...
const LOBBY_FISH_SKIN_CATALOG: readonly Omit<FishSkin, "owned">[] = [
  ...
  { id: "shark_classic", name: "Стандартная акула", asset: "/lobby/assets/fish/shark_classic.png", rarity: "rare", mode: "both" },
  { id: "shark_tiger", name: "Тигровая акула", asset: "/lobby/assets/fish/shark_tiger.png", rarity: "rare", mode: "both" },
  { id: "shark_shadow", name: "Акула Тень", asset: "/lobby/assets/fish/shark_shadow.png", rarity: "rare", mode: "both" },
  { id: "shark_azure", name: "Акула Азур", asset: "/lobby/assets/fish/shark_azure.png", rarity: "rare", mode: "both" },
  { id: "shark_white", name: "Белая акула", asset: "/lobby/assets/fish/shark_white.png", rarity: "epic", mode: "both" },
...
function LobbyStyles() {
  return (
    <style>{`
      ...
      .hubFishLayer.is-entering img {
        animation: hubFishIdleSwim 5.5s ease-in-out infinite;
      }

      .hubFishLayer.is-exiting img {
      ...
      @keyframes hubFishIdleSwim {
        0% {
          transform: translate3d(-10px, 0px, 0) rotate(-1.2deg) scale(.99);
          filter: brightness(1.02) saturate(1.06);
        }
        25% {
          transform: translate3d(4px, -8px, 0) rotate(.8deg) scale(1.01);
          filter: brightness(1.06) saturate(1.10);
        }
        50% {
          transform: translate3d(12px, 1px, 0) rotate(1.2deg) scale(1.02);
          filter: brightness(1.05) saturate(1.12);
        }
        75% {
          transform: translate3d(2px, 8px, 0) rotate(-.4deg) scale(1);
