...
const required = [
  ...
  [manifest.version === "0.5.2-blackcrown.3", "runtime version"],
  ...
  [manifest.capabilities.includes("mobile-premium-materials"), "manifest premium mobile material capability"],
  [runtime.includes("bc.world.quiet-valley.v1"), "runtime save namespace"],
  [runtime.includes("blackcrown.world.v1"), "runtime bridge"],
  [runtime.includes("0.5.2-blackcrown.3"), "runtime version marker"],
  [runtime.includes("this.mobileSafe"), "mobile-safe renderer selection"],
  [runtime.includes("mobile-premium-v1"), "premium mobile renderer revision"],
  [runtime.includes("Mobile premium renderer"), "mobile premium postprocess bypass"],
  [runtime.includes("setTimeout(() => startRenderLoop(), 16)"), "non-blocking render-loop startup"],
  [runtime.includes("renderer.mobileSafe ? 0.67 : 0.78"), "mobile camera framing"],
  [runtime.includes("animal.stock === 0 && animal.hunger > 35"), "mobile label declutter"],
  [runtime.includes("feature.kind === 'person'"), "mobile feature declutter"],
  [runtime.includes("[hidden]{display:none!important}"), "reliable hidden-state CSS"],
  [runtime.includes(".left-stack .hud-card:nth-child(2)"), "compact mobile HUD"],
