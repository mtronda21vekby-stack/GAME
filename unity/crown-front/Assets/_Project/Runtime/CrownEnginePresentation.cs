...
namespace CrownFront.Cloud
{
    ...
    public sealed class CrownAudioHooks : MonoBehaviour
    {
        ...
        public void Play(CrownAudioCue cue)
        {
            ...
            _source.volume = 0.42f * (cue == CrownAudioCue.TitanAmbient ? CrownRuntimePreferences.MusicVolume : CrownRuntimePreferences.SfxVolume);
    ...
    public sealed class CrownBuildingPresentation : MonoBehaviour
    {
        ...
        public void Configure(bool isCore, Transform visualRoot, Transform turret, Transform barrel, Transform muzzle, Transform energy, Transform[] rings)
        {
            ...
            _visualBasePosition = visualRoot != null ? visualRoot.localPosition : Vector3.zero;
            _visualBaseRotation = visualRoot != null ? visualRoot.localRotation : Quaternion.identity;
        ...
        public void ResetState()
        {
            _destroyed = false;
            _damage = 0f;
            _shotTime = _hitTime = _destroyTime = -10f;
            if (_visualRoot != null)
            {
            ...
            if (_barrel != null) _barrel.localPosition = _barrelBasePosition;
        }
